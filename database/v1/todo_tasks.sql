...
CREATE TABLE `tasks` (
  ...
  CONSTRAINT `taskTypeId` FOREIGN KEY (`taskId`) REFERENCES `tasktypes` (`typeId`)
...
INSERT INTO `tasks` VALUES (0,'Start a improved TODO-App project.',0,'2021-05-04','2021-05-04',1,1);
...
-- Dump completed on 2021-05-04 18:50:18
